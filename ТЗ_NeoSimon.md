...
time_settings:
  ...
  personal_cooldown: 3600      # Раз в какое время можно брать персональные задания
```
...
- Игрок может взять в любое время, но только если времени на выполнение больше чем времени до следующего ивента
